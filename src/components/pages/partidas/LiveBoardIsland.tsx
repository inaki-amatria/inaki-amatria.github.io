...
export default function LiveBoardIsland({
  ...
  return (
    ...
    >
      <span class="label-sm">
        {t('LiveBoardIsland.table')} {index + 1}
      </span>
      ...
      <div class="flex items-center justify-between gap-4">
        <h3 class="flex-1 truncate text-gray-600">
          ...
          {mode === "skeleton" ? t('LiveBoardIsland.black') : black?.name ?? t('LiveBoardIsland.black')}
        </h3>
      ...
      <div class="flex items-center justify-between gap-4">
        <h3 class="flex-1 truncate text-gray-600">
          ...
          {mode === "skeleton" ? t('LiveBoardIsland.white') : white?.name ?? t('LiveBoardIsland.white')}
        </h3>
        <span class="text-blue-900">
